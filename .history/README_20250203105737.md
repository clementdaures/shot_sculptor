...
It appears that PyMEL is no longer supported in Maya 2025 and later versions. Clément Daures is currently developing version 2.0 of ShotSculptor, which will utilize vanilla Python (cmds), MEL, and OpenMaya commands.
